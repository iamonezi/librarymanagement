<%-- 
    Document   : ShowBill
    Created on : Jul 16, 2022, 1:32:58 PM
    Author     : Vo Viet Nhan
--%>
                                ...
                                <table id="datatablesSimple" style="border: 1px solid black">
                                    <table id="datatablesSimple" style="border: 1px solid black">
                                        <tr style="border: 1px solid black;text-align: center;">
                                            ...
                                            <td style="border: 1px solid black;text-align: center;">Book Get</td>
                                            <td style="border: 1px solid black;text-align: center;">Day Get</td>
                                            <td></td>
                                        </tr>
                                        <c:forEach items="${bill}" var="o">
                                            <tr style="border: 1px solid black;" >
                                                ...
                                                <td style="border: 1px solid black;text-align: center;">
                                                    <form action="ProcessedBillNew" method="POST">
                                                        ...
                                                        <input class="icon" type="date" name="dayGet" placeholder="yyyy-mm-dd" required="">
