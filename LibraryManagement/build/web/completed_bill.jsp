<%-- 
    Document   : completed_bill
    Created on : Jul 17, 2022, 3:48:15 PM
    Author     : PC
--%>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Completed Bill</h1>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" style="border: 1px solid black">
                                    ...
                                    <tr style="border: 1px solid black;text-align: center;">
                                        ...
                                        <td style="border: 1px solid black;text-align: center;">Get Day</td>
                                        <td style="border: 1px solid black;text-align: center;">Return Day</td>
                                        <td style="border: 1px solid black;text-align: center;">Manager</td>
                                    ...
                                    <c:forEach items="${bill}" var="o">
                                        <tr style="border: 1px solid black;" >
                                            ...
                                            <td style="border: 1px solid black;text-align: center;"><img src="${o.img}" style="width: 100px;height: 100px;"></td>
                                            ...
                                            <td style="border: 1px solid black;text-align: center;">${o.date_get}</td>
                                            <td style="border: 1px solid black;text-align: center;">${o.date_return}</td>
                                            <td style="border: 1px solid black;text-align: center;">${o.manager}</td>
                                            <td style="border: 1px solid black;text-align: center;">Done</td>
                                        </tr>
                                    </c:forEach>
                                </table>
                            </div>
