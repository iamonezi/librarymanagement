                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" style="border: 1px solid black">
                                    <tr style="border: 1px solid black ">
                                        ...
                                        <td style="border: 1px solid black;padding: 0 15px; text-align: center;">PUBLISHING YEAR</td>
                                    ...
                                    <c:forEach items="${listB}" var="o">
                                        <tr style="border: 1px solid black;" >
                                            ...
                                            <td style="border: 1px solid black;padding: 0 15px;text-align: center;">${o.year}</td>
                                            ...
                                            <td>
                                                ...
                                                <a href="delete?bid=${o.id}"><button type="submit" class="btn btn-outline-primary">Delete</button></a></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </table>
