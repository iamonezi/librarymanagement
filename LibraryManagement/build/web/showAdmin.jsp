                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                DataTable 
                                <a href="InsertAdmin.jsp"><button type="submit" class="btn btn-outline-primary">Add new Admin</button></a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple" style="border: 1px solid black">
                                    ...
                                    <c:forEach items="${admin}" var="o">
                                        <tr style="border: 1px solid black;" >
                                            ...
                                            <td >${o.salary}</td>
                                            <td>
                                                <a href="UpdateAdmin?aid=${o.id}"><button type="submit" class="btn btn-outline-primary" >Update</button></a></a>
                                                <a href="DeleteAdmin?aid=${o.id}"><button type="submit" class="btn btn-outline-primary">Delete</button></a></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </table>
